...
#define SD_PWR_CTRL_MASK    (1UL<<21)
#define SD_PWR_CTRL_DIR     IO0DIR
#define SD_PWR_CTRL_FDIR    FIO0DIR
#define SD_PWR_CTRL_SET     IO0SET
#define SD_PWR_CTRL_FSET    FIO0SET
#define SD_PWR_CTRL_CLR     IO0CLR
#define SD_PWR_CTRL_FCLR    FIO0CLR
#define SD_PWR_CTRL_IO      IO0PIN
#define SD_PWR_CTRL_FIO     FIO0PIN
#define SD_PWR_CTRL_SEL     PINSEL1_bit.P0_21
#define SD_PWR_CTRL_MODE    PINMODE1_bit.P0_21

#define SD_CMD_MODE         PINMODE1_bit.P0_20
