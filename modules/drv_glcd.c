...
#define C_GLCD_PIX_CLK          (6.4MHZ)//(6.4MHZ)

//extern Int32U SDRAM_BASE_ADDR;

//#define LCD_VRAM_BASE_ADDR SRAM_BASE_ADDR //((Int32U)&SRAM_BASE_ADDR)
...
static pInt32U VramAddr;

pInt32U GetVramAddr(void) {return VramAddr;};                                      //newly added
void SetVramAddr(pInt32U value) {VramAddr = value;};                               //newly add
/*
static pInt32U PalAddr;

pInt32U GetPalAddr(void) {return PalAddr;};                                       //newly added
void SetPalAddr(pInt32U value) {PalAddr = value;};                               //newly add
*/
/*************************************************************************
...
{
  CRSR_PAL1 = 0x00000000;
  CRSR_PAL0 = 0x00FFFFFF;
  CRSR_CFG = Cfg;
}
/*************************************************************************
...
{
pInt32U pDst = GetVramAddr();//(pInt32U) LCD_VRAM_BASE_ADDR;
  // Assign pin
 ...
 // LCD_POL_bit.IPC    = 1;   // data is driven out into the LCD on the falling edge
  ...
  LCD_UPBASE         =  (Int32U)GetVramAddr()  & ~7UL;//LCD_VRAM_BASE_ADDR & ~7UL ;
 // LCD_LPBASE         =  (Int32U)GetVramAddr() & ~7UL;//LCD_VRAM_BASE_ADDR & ~7UL ;
  // init colour pallet
...
{
pInt32U pDst = (pInt32U)0xFFE10200; //LCD_PAL_BASE;
  assert(pPallete);
...
{
  pPix = pWind = (/*(pInt32U)LCD_VRAM_BASE_ADDR*/GetVramAddr()) + X_Left + (Y_Up*C_GLCD_H_SIZE);
...
{
pInt32U pData = (/*(pInt32U) LCD_VRAM_BASE_ADDR*/GetVramAddr()) + X_Left + (Y_Up * C_GLCD_H_SIZE);
