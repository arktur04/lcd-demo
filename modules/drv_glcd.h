...
//#define LCD_VRAM_BASE_ADDR 0x40000000

pInt32U GetVramAddr(void);
void SetVramAddr(pInt32U value);

//pInt32U GetPalAddr(void);
//void SetPalAddr(pInt32U value);
...
//#define C_GLCD_REFRESH_FREQ     (50HZ)
#define C_GLCD_H_SIZE           320
#define C_GLCD_H_PULSE          1
#define C_GLCD_H_FRONT_PORCH    18
#define C_GLCD_H_BACK_PORCH     69

#define C_GLCD_V_SIZE           240
#define C_GLCD_V_PULSE          1
#define C_GLCD_V_FRONT_PORCH    11//10
#define C_GLCD_V_BACK_PORCH     11//12
